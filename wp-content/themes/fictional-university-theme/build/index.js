...
class Like {
  ...
  ourClickDispatcher(e) {
    ...
    var currentLikBox = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest(".like-box"); // Aquí se enviarán las requests para add a like or delete a like. 
  ...
  createLike(currentLikBox) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      type: 'POST',
      data: {
        'professorId': currentLikBox.data('professor')
      },
      success: response => {
...
class Search {
  ...
  } // Se usa un ternary Operator para usar un condicional y de esa manera tener dos opciones: la opción en la que haya post y la opción en la que
  // no haya post. 
  ...
  openOverlay() {
    ...
    this.searchField.val(""); // El .focus no funciona y no sé por qué. 
  ...
  closeOverlay() {
    ...
    this.isOverlayOpen = false;
  } // El .append sirve para agregar un html al final. 
